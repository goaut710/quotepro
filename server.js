...
<div class="doc">
  ...
  <div style="display:flex;justify-content:space-between;margin-bottom:16px;gap:20px">
    <div style="flex:1">
      <div style="font-size:9px;font-weight:700;letter-spacing:2px;color:#aaa;margin-bottom:5px;text-transform:uppercase">Para</div>
      <div style="font-size:14px;font-weight:700;color:#111">${esc(client_name)}</div>
      ${client_phone?`<div style="font-size:12px;color:#555;margin-top:2px">📞 ${esc(client_phone)}</div>`:''}
      ${client_email?`<div style="font-size:12px;color:#555;margin-top:2px">✉️ ${esc(client_email)}</div>`:''}
    </div>
  </div>
